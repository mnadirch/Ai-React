...
const Navbar: React.FC = () => {
  ...
  ☰
    ...
    rounded lg:rounded-none z-50`}
      ...
      <button className="hidden lg:flex relative px-4 py-2 text-xs sm:text-sm md:text-base font-medium cursor-pointer border border-[#ADFF00] transition-all duration-300 bg-[#ADFF00] text-black hover:bg-black hover:text-white">
  Get Connected
